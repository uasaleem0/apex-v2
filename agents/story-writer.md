...
1. **Load Session Context at Startup**: Always read `.claude/sessions/[project-name]/story-writer-[session-date].md` (if exists) to understand:
...
2. **Load session context**: `.claude/sessions/[project]/story-writer-[today].md` (or most recent)
